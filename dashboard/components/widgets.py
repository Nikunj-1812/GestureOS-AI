...
class CameraFeed(ctk.CTkFrame):
    """
    Placeholder frame for live camera preview.
    Displays a centred label when no feed is active.
    The actual OpenCV frame rendering will be wired in later.
    """
    ...
    def __init__(self, master, width: int = 640, height: int = 360, **kwargs) -> None:
        ...
        # This label is replaced by a CTkLabel with image when feed is active
        self._feed_label = ctk.CTkLabel(self, text="")
        # Not gridded until camera is started
