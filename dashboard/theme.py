...
# ─────────────────────────────────────────────────────────────────
# PAGE REGISTRY  — single source of truth for nav items
# ─────────────────────────────────────────────────────────────────
#
# Each entry:
#   "key"     : internal identifier (used to switch pages)
#   "label"   : display name in sidebar
#   "icon"    : Unicode symbol shown beside the label
#   "section" : groups items under section headers
